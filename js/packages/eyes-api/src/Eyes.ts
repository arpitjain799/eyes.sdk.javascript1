...
export class Eyes<TSpec extends Core.SpecType = Core.SpecType> {
  protected static readonly _sdk: SDKOptions<Core.SpecType>
  protected get _sdk(): SDKOptions<TSpec> {
    return (this.constructor as typeof Eyes)._sdk as SDKOptions<TSpec>
  }
