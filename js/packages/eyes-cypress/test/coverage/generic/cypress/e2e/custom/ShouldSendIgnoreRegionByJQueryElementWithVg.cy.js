...
describe('Coverage tests', () => {
  it('should send ignore region by JQuery element with vg', () => {
    cy.visit('https://applitools.github.io/demo/TestPages/FramesTestPage/');
    cy.eyesOpen({
      appName: 'Eyes Selenium SDK - Fluent API',
      displayName: 'should send ignore region by JQuery element with vg',
      testName: 'TestIgnoreRegionByJQueryElement_VG',
