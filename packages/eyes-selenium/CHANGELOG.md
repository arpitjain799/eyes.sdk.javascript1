...
- updated to @applitools/visual-grid-client@15.8.18 (from 15.8.12)
...
- updated to @applitools/eyes-sdk-core@12.21.1 (from 12.20.0)
- updated to @applitools/visual-grid-client@15.8.11 (from 15.8.7)
...
- updated to @applitools/visual-grid-client@15.8.2 (from 15.7.0)

## 4.53.0 - 2021/3/29

- updated to @applitools/eyes-sdk-core@12.17.0 (from 12.16.2)
- updated to @applitools/visual-grid-client@15.7.0 (from 15.6.2)

## 4.52.8 - 2021/3/16

- updated to @applitools/visual-grid-client@15.6.0 (from 15.5.22)
- updated to @applitools/eyes-sdk-core@12.15.2 (from 12.15.1)
- updated to @applitools/eyes-sdk-core@12.16.2 (from 12.15.2)
- updated to @applitools/visual-grid-client@15.6.2 (from 15.6.0)

## 4.52.7 - 2021/2/18

- updated to @applitools/eyes-sdk-core@12.14.10 (from 12.14.8)
- updated to @applitools/visual-grid-client@15.5.22 (from 15.5.21)
